$(document).ready(function() {
	...
	var tl = new TimelineLite({paused:true});
			tl.to("#myObject", 1, {x:100, y:100, z:300, transformOrigin:" 50% 50%"} );

	var tl2 = new TimelineLite({paused:true});
			tl2.to("#myObject", 1, {x:400, y:600} )
	...
	var tl4 = new TimelineLite({paused:true});
			tl4.to("#myObject", 1, {x:300, y:1500})
	...
	var tl6 = new TimelineLite({paused:true});
			tl6.to("#myObject2", 1, { x:-200, opacity:0})
	...
	var tl7 = new TimelineLite({paused:true});
			tl7.to("#myObject", 1, { y:2700, x:300});
	var tl8 = new TimelineLite({paused:true});
		tl8.to("#myObject", 1, {x:355, y:3370, z:0});
	...
	$(document).scroll(function() {
		...
		if( scrollValue < 10){
				...
				if(section1Inited == false){
					section1Inited = true;
					
					TweenMax.set("#myObject", 1, {left:00, y:150} );
					
				}
		}	
		
			else if(scrollValue >= 10 && scrollValue < 500){
				//start motion
				if(section2Inited == false){
					section2Inited = true;
					tl.play();
