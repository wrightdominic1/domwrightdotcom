$(document).ready(function() {
	...
	$("#myForm").on("submit",function(event){
		...
		console.log("pulpfiction2.html"+"?"+"valueOfFirst="+firstTextField+"&valueOfSecond="+secondTextField+"&valueOfThird="+thirdTextField+"&valueOffourth="+fourthTextField+"&valueOfFifth="+fifthTextField+"&valueOfSixth="+sixthTextField+"&valueOfSeventh="+seventhTextField+"&valueOfEighth="+eighthTextField+"&valueOfNinth="+ninthTextField+"&valueOfTenth="+tenthTextField+"&valueOfEleven="+elevenTextField+"&valueOfTwelve="+twelveTextField);
		
		window.location = "pulpfiction2.html"+"?"+"valueOfFirst="+firstTextField+"&valueOfSecond="+secondTextField+"&valueOfThird="+thirdTextField+"&valueOffourth="+fourthTextField+"&valueOfFifth="+fifthTextField+"&valueOfSixth="+sixthTextField+"&valueOfSeventh="+seventhTextField+"&valueOfEighth="+eighthTextField+"&valueOfNinth="+ninthTextField+"&valueOfTenth="+tenthTextField+"&valueOfEleven="+elevenTextField+"&valueOfTwelve="+twelveTextField;
	});
		
	
	// FUNCTIONS
	$('h1').addClass('animated fadeInDown');
	$('#numberTwo').addClass('animated fadeInLeft');
